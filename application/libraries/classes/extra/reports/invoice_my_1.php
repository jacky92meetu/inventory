 ...
 * $arguments['data']
 */
$template_path = APPPATH.'libraries/classes/templates/invoice_my_1.xlsx';
...
if(!isset($arguments['return_object'])){
    $filename = $arguments['header']['name']."_".$arguments['header']['inv_text'];
}
...
$worksheet->setCellValueExplicit('H9', date("d-m-Y",strtotime($arguments['header']['payment_date'])));
$worksheet->setCellValueExplicit('H11', $arguments['header']['inv_text']);
$worksheet->setCellValueExplicit('H13', $arguments['header']['sales_id']);
